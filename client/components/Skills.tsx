    ...
    <div className="flex flex-col items-center w-full h-full">
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <div className="p-1 flex items-center justify-center rounded-lg border border-white/8 bg-white/3 backdrop-blur-sm transition-all duration-300 group-hover:border-white/15 group-hover:bg-white/5">
            <Icon
              name={icon}
              size={40}
          ...
          return (
            <div key={groupName} className="mb-24">
              <div className="flex items-center mb-10">
                <h3 className="mx-4 text-3xl font-medium uppercase italic tracking-wider">
                  {groupName}
                </h3>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 cursor-default">
                {groupSkills.map((skill, i) => {
                  ...
                  const delay =
                    (Math.floor(i / 4) * 200 + (i % 4) * 100) / 1000;
                  return (
                    <motion.div
                      key={skill.name}
