  ...
  return (
    <div className='relative overflow-hidden border border-white/10 bg-black/50 backdrop-blur-sm'>
      <div className='relative h-32 overflow-hidden bg-white/5'>
        <img src='banner.png' alt='Profile Banner' className='h-full w-full object-cover' />
      </div>
      ...
      <div className='relative p-6'>
        ...
        <div className='mb-6 space-y-4'>
          <div className='grid grid-cols-2 gap-4'>
            <div className='space-y-2'>
              <label className='text-sm font-medium uppercase tracking-wider text-gray-500'>First Name</label>
              <div className='border border-white/10 bg-white/5 px-3 py-2 text-sm text-gray-300'>SOCHEATH EK</div>
            </div>
            <div className='space-y-2'>
              <label className='text-sm font-medium uppercase tracking-wider text-gray-500'>Last Name</label>
        ...
        <div className='mb-6 space-y-2'>
          ...
          <a href='mailto:maosocheathek@gmail.com' className='block'>
            <div className='flex items-center gap-3 border border-white/10 bg-white/5 px-3 py-2 text-sm text-gray-300 transition-colors hover:border-white/20 hover:bg-white/10'>
              <HugeiconsIcon icon={Mail01Icon} size={20} className='text-gray-500' />
        ...
        <a href='/cv.pdf' download>
          <Button
            variant='default'
            className='group w-full rounded-none border border-white/30 bg-transparent px-8 text-white transition-all hover:border-white hover:bg-white/20'
          >
