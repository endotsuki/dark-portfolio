...
⏰ *Sent:* ${new Date().toLocaleString()}`;
  ...
  return (
    <section
      id="contact"
      className="overflow-hidden bg-slate-950 pt-16 px-2 relative"
    >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      I will get back to you as soon as possible. Usually within
                      24 hours.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="relative z-10 flex items-start gap-5">
                    ...
                    <div className="flex-1 transition-transform duration-500 group-hover:-translate-x-16">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <IconBrowserShare
                          size={20}
                          className="text-gray-400 group-hover:text-gray-300 group-hover:translate-x-16 translate-x-20 transition-all"
                        />
                      </div>
                ...
                <div className="relative z-10">
                  <div className="mb-10">
                    ...
                    <p className="text-gray-300">
                      Connected to Telegram for instant notifications
                    </p>
                  </div>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <Textarea
                        ...
                        required
                        rows={6}
                        className="bg-black/50 border-white/20 text-white placeholder:text-gray-500 focus:border-white focus:ring-white/20 transition-all rounded-xl resize-none text-base"
                      ...
                      <div className="relative z-10 flex items-center justify-center">
                        {isSubmitting ? (
                          ...
                          <>
                            <IconSend2
                              size={23}
                              className="mr-3 transition-transform duration-500 group-hover:-translate-x-96"
                            />
                            <span className="group-hover:translate-x-96 transition-all duration-500">
                              Send Message
                            </span>
                          </>
                        )}
